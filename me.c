...
int main() 
{
    printf("hello! this is me! this is a journal of what happens when i do shit.\n");
    printf("i am writing this in C because i am autistic\n");
    printf("as much as i love drugs, it must come to an end one day\n");
    printf("no idea how!\n")
    system("aplay killingmyself.mp3");
    printf("did 3000mg of methocarbamol so far, and drank like 6 shots so far\n");
